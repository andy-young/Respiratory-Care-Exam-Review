...
- Blood Pressure
  ...
  - Normal range for children: 95-118/54-66
  - Normal range for neonates: 67-84/35-53
  - Systolic pressure (first or top number) is the pressure measured during ventricular contraction.
  - Diastolic pressure (last or bottom number) is the pressure measured while the ventricles are at rest.
  - The diastolic pressure is the most critical measurement because it is the lowest pressure that the heart and arterial system experience.
  - An abnormally low blood pressure is called **hypotension** and is usually caused by shock, high-volume blood loss, positioning, and central nervous system(CNS) depressant drugs.
  - An abnormally high blood pressur eis called **hypertension** and is usually caused by cardiovascular imbalances, stimulant drugs, stress, and fluid retentin resulting from renal failure.
...
- Body Temperature
  ...
  - Slightly higher temperature in children is normal as a result of a higher metabolic rate.
  - An abnormally low body temperature is called **hypothermia** and is caused by sweating (diaphoresis), blood loss, exposure to cold temperatures, and abnormally high heat loss.
  - An abnormally high body temperature is called **hyperthermia** and is caused by decreased heat loss, infection, or increased environmental temperature.
  > :warning: A fever results in increased O<sub>2</sub> consumption, which leads to an increased work of breathing to meet the increased O<sub>2</sub> demands of the body. The production of CO<sub>2</sub> increases as well. COPD patients may exhibit chronic hyoxemia and hypercapnia, which can result in acute exacerbation of symptoms.
  - The term used to describe a person with normal body temperature is **afebrile;** the term used to describe a person with a fever is **febrile.**
- Assessing Mental Status
  - Level of consciousness
    - Alert: Patient is awake and responds to stimuli.
    - Obtunded and confused: Patient is awake but responds slowly to commands and may be disoriented.
    - Lethargic: Patient seems unconscious but, when stimulated, does awaken.
    - Coma: Patient is unconscious and, when stimulated, does not awaken.
  - Orientation to time and place
    - Ask patient the date
    - Ask whether patient knows where he or she is.
  - Ability to cooperate
    - Ask patient to follow simple commands.
    - Patient cooperation is necessary for effective therapy, such as incentive spirometry or IPPB.
  - Emotional State
    - Ask patient to describe his or her feelings.
    - Note patient's emotional response while you are asking questions.
  - Glasgow Coma Scale (determines neurologic impairment)
    - A score of 12 to 15 generally doesn't require admission to ICU
    - A score of 9 to 12 indicated a moderate coma
    - A score lower than 8 to 9 indicates severe coma (Lower than 8 requires ET intubation to preotect the airway for ventilatory assistance.)
  - Apnea test (to determine brain death)
    - Blood gas values need to be normalized before the test. The patient is then discontinued from the ventilator and placed on 100% oxygen.
    - Spontaneous breathing, exygenation,and cardiac status are monitored during the test. A physcician will end the test when signs of clinical deterioration are observed and no spontaneous breathing is presnt for 8 to 10 minutes. After this time, an ABG is drawn and the patient is placed back on the ventilator.
    - A positive apnea test is indicated if the ABG results show that the PaCO<sub>2</sub> has increased 20 torr above the baseline level or reaches a level of 60 torr. This indicats that the patient was apneic and that brain death is likely.
...
## IV. ASSESSMENT OF LABORATORY TEST RESULTS
 ...
 - Serum Electrolytes
  - Sodium (Na<sup>+</sup>)
    ...
    - Na<sup>+</sup> is the major cation in the extracellular fluid, and its concentration is controlled by the kidneys by means of regulating the amount of water in the body.
